...
#define ACTIVITY_FIELD                                                                             \
  ...
  u32 tid; /* thread ID that initiated this memcpy */                                              \
  u64 bytes;                                                                                       \
  u16 copyKind; /* CUpti_ActivityMemcpyKind: H2D=1, D2H=2, D2D=8, P2P=10 */                        \
  u16 sync;     /* 1=synchronous, 0=asynchronous */                                                \
                                                                                                   \
  /* kernel */                                                                                     \
  u32 graphId;                                                                                     \
  u64 graphNodeId;
