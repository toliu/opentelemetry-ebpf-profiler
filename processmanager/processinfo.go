...
// HasPID reports whether the process manager has information about the given PID.
func (pm *ProcessManager) HasPID(pid libpf.PID) bool {
	pm.mu.RLock()
	defer pm.mu.RUnlock()
	_, ok := pm.pidToProcessInfo[pid]
	return ok
}
